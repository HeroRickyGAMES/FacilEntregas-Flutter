...
class _CadastroScreenState extends State<CadastroScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    cadastrarmt() async {
      ...
      print("Endereço: ${placemark.street}, ${placemark.subLocality}, ${placemark.locality}, ${placemark.administrativeArea} ${placemark.postalCode}, ${placemark.country}");
                  ...
                  if(EnderecoLoja == ''){
                    ...
                    if(kIsWeb){
                      ...
                      if(Platform.isAndroid){
                        ...
                        List<Location> locations = await locationFromAddress(EnderecoLoja);
